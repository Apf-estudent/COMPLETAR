    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qr', models.ImageField(blank=True, null=True, upload_to='medicamentos/qr/')),
                ...
                ('id_estado', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='medicamentos.estado')),
                ('id_nivel_de_riesgo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='medicamentos.nivel_riesgo')),
            ],
        ),
    ]
